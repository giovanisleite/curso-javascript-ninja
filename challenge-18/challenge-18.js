(function() {
  ...
  [
    ...
    "735 500 794 - 22",
    "101.123-131x32"
  ].forEach(cpf => console.log(cleanCPF(cpf)));
  ...
  ["049-214 3421-1", "210.458.522-05", "735 500 794 - 22", "101.123-131x32"]
    .map(cpf =>
  ...
  console.log(
    "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>".replace(
      /<(w+)>(.+)<\/\1>/g,
      (_, g1, g2) => `<${g1}>O texto dentro da tag ${g1} é "${g2}"</${g1}>`
    )
  );
})();
