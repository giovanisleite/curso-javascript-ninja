(function(window, document) {
  ...
  /*
    ...
    */
  var username = window.prompt("Qual o seu nome?") || "Desconhecido";
  ...
  /*
    ...
    `$inputUsername`.
    */
  var $inputUsername = document.querySelector("input");
  /*
  ...
  $button.addEventListener(
    ...
    function(event) {
      ...
      if (!$inputUsername.value) {
        return window.alert("Preencha o nome do usuário!");
      }
      if (!$inputEmail.value) {
        return window.alert("Preencha o email do usuário!");
      }
      if (!$message.value) {
      ...
      if (window.confirm("Tem certeza que deseja enviar?"))
        return window.alert("Enviado com sucesso!");
      return window.alert("Não enviado.");
    },
    false
  );
  /*
