(function() {
  ...
  var pessoa1 = new Person("Jose", "Silva");
  var pessoa2 = new Person("Maria", "Joana");
  ...
  function sum() {
    ...
    return Array.prototype.reduce.call(
      arguments,
      (acumulated, current) => acumulated + current,
      0
    );
  }
  ...
  var justNumbers = str =>
    str.match(/\d+/g).map(numberStr => parseInt(numberStr, 10));
