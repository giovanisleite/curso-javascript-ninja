(function() {
  ...
  */
  ...
  var pessoa1 = new Person("João", "Silva", 22);
  var pessoa2 = new Person("Maria", "Silva", 24);
  var pessoa3 = new Person("Joana", "Silva", 17);
  console.log(pessoa1);
  console.log(pessoa2);
  console.log(pessoa3);
  ...
  */
  ...
  console.log(
    pessoa1.getFullName() +
      " agora tem " +
      pessoa1.addAge(2).getAge() +
      " anos."
  );
  console.log(
    pessoa2.getFullName() +
      " agora tem " +
      pessoa2.addAge(1).getAge() +
      " anos."
  );
  console.log(
    pessoa3.getFullName() +
      " agora tem " +
      pessoa3.addAge(4).getAge() +
      " anos."
  );
})();
